...
const CSS_TEMPLATE = /* css */ `
    ...
    *:focus-visible {
    ...
    #session-menu {
      ...
      min-width: 280px; z-index: 1000;
      font-family: var(--ui-font);
    }
    .session-menu-header {
      display: flex; justify-content: space-between; align-items: center;
      padding: 12px; border-bottom: 1px solid var(--vscode-sideBarSectionHeader-border);
    }
    .session-menu-title {
      font-weight: 600; font-size: 0.9em; color: var(--vscode-foreground);
    }
    .session-menu-close {
